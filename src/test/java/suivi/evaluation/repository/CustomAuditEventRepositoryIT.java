package suivi.evaluation.repository;

import suivi.evaluation.SvrevaluationApp;

import suivi.evaluation.config.Constants;
import suivi.evaluation.config.audit.AuditEventConverter;
import suivi.evaluation.domain.PersistentAuditEvent;
...
import static suivi.evaluation.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
